    ...
    def decide(
        ...
        if confidence < 75:
            ...
            if num_strategies_agree >= 3:
                ...
                lev = min(1.5, cap)  # 2_agree: reduced leverage, rm=0.6 is the real penalty
        ...
        if confidence < 80:
            ...
            if num_strategies_agree >= 3:
                ...
                lev = min(1.5, cap)  # 2_agree: reduced leverage, rm=0.7 is the real penalty
        ...
        if num_strategies_agree >= 3:
            ...
            lev = min(1.5, cap)  # 2-agree: reduced leverage, rm=0.7 is the real penalty
            rm = 0.7
        else:
            lev = min(1.0, cap)
            rm = 0.6
