...
function RollingMetrics({ trades }: { trades: TradeRecord[] }) {
  ...
  return (
    <div className="card-hover glass-noise" style={{ ...Glass.crystal, border: `1px solid ${C.border}`, borderRadius: R.xl, padding: '20px 24px', marginBottom: 20 }}>
...
function ProfitFactorGauge({ trades }: { trades: TradeRecord[] }) {
  ...
  return (
    <div className="card-hover glass-noise" style={{
      ...Glass.crystal, border: `1px solid ${C.border}`, borderRadius: R.lg,
...
function FeeDragAnalysis({ trades }: { trades: TradeRecord[] }) {
  ...
  if (!grossPnlSeries.length) {
    return (
      <div className="card-hover glass-noise" style={{ ...Glass.crystal, border: `1px solid ${C.border}`, borderRadius: R.lg, padding: '20px 24px', boxShadow: S.sm, marginBottom: 20 }}>
