...
function GateFunnelChart() {
  ...
  return (
    <div className="card-hover glass-noise" style={{ ...Glass.crystal, borderRadius: R.lg, padding: '18px 20px', marginTop: 20 }}>
...
function StrategyCard({ name, desc, data, why }: { name: string; desc: string; data: string; why: string }) {
  return (
    <div className="card-hover glass-noise" style={{ ...Glass.crystal, borderRadius: R.lg, padding: '20px 22px' }}>
...
function TransparencyScoreCard() {
  ...
  return (
    <div className="card-hover glass-noise" style={{ ...Glass.crystal, borderRadius: R.lg, padding: '20px 22px', marginTop: 24 }}>
      ...
      <div className="bg-aurora" style={{ maxWidth: 860, margin: '0 auto', padding: '32px 20px', position: 'relative' }}>
        ...
        <Section id="agents" eyebrow="The AI Brain" title="7 agents debate every trade.">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {AGENTS.map((a) => (
              <div key={a.name} className="card-hover glass-noise" style={{ ...Glass.crystal, border: `1px solid ${a.color}30`, borderRadius: R.lg, padding: '16px 20px', display: 'flex', gap: 16, flexWrap: 'wrap' }}>
        ...
        <Section eyebrow="Our Commitments" title="What we promise.">
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              ...
              <div key={n} className="card-hover glass-noise" style={{ display: 'flex', gap: 14, padding: '12px 16px', ...Glass.crystal, borderRadius: R.md, border: `1px solid ${C.border}`, alignItems: 'flex-start' }}>
